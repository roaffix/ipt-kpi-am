...
def booking_info(filename='booking_info.yml'):
    ...
    return info['FLY_INFO'], info['HOTEL_INFO']
...
def sql_queries():
    ...
    """
    fly_info, hotel_info = booking_info()
    ...
    return fly_query_str, hotel_query_str


def dtc(fly_booking_db, hotel_booking_db):
    """
    ...
    try:
        ...
        print('> Connection to PostgreSQL Server was successfully established...\n')
    ...
    try:
        ...
        fly_booking_query, hotel_booking_query = sql_queries()
        ...
        print('> TPC transaction was successfully commited.\n')
